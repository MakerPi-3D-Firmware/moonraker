...
RELEASE_URL = "https://api.github.com/repos/MakerPi-3D-Firmware/moonraker/releases"
GIT_MAX_LOG_CNT = 100
GIT_LOG_FMT = \
    "sha:%H%x1Dauthor:%an%x1Ddate:%ct%x1Dsubject:%s%x1Dmessage:%b%x1E"
OWNER_REPOS = {
    'moonraker': "MakerPi-3D-Firmware/moonraker",
    'klippy': "MakerPi-3D-Firmware/klipper"
}
INSTALL_SCRIPTS = {
    'klippy': {
